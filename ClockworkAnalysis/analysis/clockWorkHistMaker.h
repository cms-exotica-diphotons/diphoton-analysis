...
// Fri Feb  3 14:06:37 2023 by ROOT version 6.12/07
...
#ifndef clockWorkHistMaker_h
#define clockWorkHistMaker_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   clockWorkHistMakerBase(TTree *tree=0);
   virtual ~clockWorkHistMakerBase();
...
#ifdef clockWorkHistMaker_cxx
clockWorkHistMakerBase::clockWorkHistMakerBase(TTree *tree) : fChain(0)
{
...
clockWorkHistMakerBase::~clockWorkHistMakerBase()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t clockWorkHistMakerBase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t clockWorkHistMakerBase::LoadTree(Long64_t entry)
{
...
void clockWorkHistMakerBase::Init(TTree *tree)
{
...
Bool_t clockWorkHistMakerBase::Notify()
{
...
void clockWorkHistMakerBase::Show(Long64_t entry)
{
...
Int_t clockWorkHistMakerBase::Cut(Long64_t entry)
{
...
#endif // #ifdef clockWorkHistMakerBase_cxx
