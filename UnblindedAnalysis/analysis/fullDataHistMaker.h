...
// Sun Jul 23 04:50:31 2023 by ROOT version 6.24/08
// from TTree fTree/DiPhotonTree
// found on file: root://eoscms//eos/cms/store/group/phys_exotica/diphoton/fullRun2/hsinyeh/Data/Data2016/Run2016H_v1_0.root
//////////////////////////////////////////////////////////

#ifndef fullDataHistMaker_h
#define fullDataHistMaker_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   fullDataHistMakerBase(TTree *tree=0);
   virtual ~fullDataHistMakerBase();
...
#ifdef fullDataHistMaker_cxx
fullDataHistMakerBase::fullDataHistMakerBase(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoscms//eos/cms/store/group/phys_exotica/diphoton/fullRun2/hsinyeh/Data/Data2016/Run2016H_v1_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoscms//eos/cms/store/group/phys_exotica/diphoton/fullRun2/hsinyeh/Data/Data2016/Run2016H_v1_0.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://eoscms//eos/cms/store/group/phys_exotica/diphoton/fullRun2/hsinyeh/Data/Data2016/Run2016H_v1_0.root:/diphoton");
...
fullDataHistMakerBase::~fullDataHistMakerBase()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fullDataHistMakerBase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fullDataHistMakerBase::LoadTree(Long64_t entry)
{
...
void fullDataHistMakerBase::Init(TTree *tree)
{
...
Bool_t fullDataHistMakerBase::Notify()
{
...
void fullDataHistMakerBase::Show(Long64_t entry)
{
...
Int_t fullDataHistMakerBase::Cut(Long64_t entry)
{
...
#endif // #ifdef fullDataHistMakerBase_cxx
